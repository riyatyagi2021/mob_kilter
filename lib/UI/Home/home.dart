...
import 'package:vendor_flutter/UI/Home/home_event.dart';
import 'package:vendor_flutter/UI/Home/home_model.dart';
...
class _HomePageState extends State<HomePage> {
 ...
 ScrollController scrollController=ScrollController();
  ...
  scrollController.addListener(pagination);
   ...
   pagination() {
   // print("${scrollController.position.pixels}   immagessssss countt");
                          ...
                          Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                  " Hello ${state.modelProfile.responseData?.employeeProfile?.firstName.toString()},",
                                  style: TextStyle(
                                      fontSize: 16,
                                ...
                                child: RefreshIndicator(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        var price = apiData?.foodItemList?[index].price;
                                        var foodId = apiData?.foodItemList?[index].foodId;
                                        var foodImage = apiData?.foodItemList?[index].images;
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                IconButton(
                                                    onPressed: () {
                                                      bottomSheet(context,
                                                          foodName!, price!,foodId!,foodImage! );
                                                    },
                                                    icon: Icon(
  ...
  Widget drawer() => BlocConsumer<HomeBloc, HomeState>(
      listener: (context, state) {},
      builder: (context, state) {
        GetMyProfileModel profileModel =state.modelProfile;
        var firstName =profileModel.responseData?.employeeProfile?.firstName?.toString();
        var lastName =profileModel.responseData?.employeeProfile?.lastName?.toString();
        var email =profileModel.responseData?.employeeProfile?.email?.toString();
        var phone =profileModel.responseData?.employeeProfile?.phone?.toString();
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          "\u{20B9} ${profileModel.responseData?.employeeProfile?.walletBalance?.toString()}",
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 14,
                              color: COLOR.White),
  ...
  bottomSheet(context, String foodname, int Price,String foodId,List<dynamic> foodImage) {
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              EditFood(foodName: foodname, price: Price,fooodId:foodId,foodImagee:foodImage)));
                    },
                    child: Row(
                      children: [
                        Image.asset(
                  ...
                  GestureDetector(
                    onTap: () {
                      log("$foodId foodid");
                      Navigator.pop(context);
                      DeletePopup(context: context,idFood:foodId).show();
                    },
                    child: Row(
                      children: [
                        Image.asset(
...
// if ( state.model.responseData?.foodItemList?.length==0) {
//   Scaffold.of(context)
//       .showSnackBar(SnackBar(content: Text('No more food')));
// }
/// to fetch data from preference utilss
...
ACCESSTOKEN = profile.accessToken.toString();
print("${foodListModel?.responseData?.foodItemList?.length}    list 22222 size");

print("${ACCESSTOKEN}  home");
});*/
